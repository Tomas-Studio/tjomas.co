...
<template>
  <div web-w pt6 relative>
    <NuxtLink
      ...
      to="/tags"
      class="absolute left--20 top-5 px3 py1.5 focusable lt-md:hidden op20 hover:op70 duration-300"
    >
      <div text-2xl i-ion:return-up-back />
    </NuxtLink>
    <div>
    ...
    <div class="my8">
      <div v-if="articles.length > 0" class="slide-enter-content">
        <h2 class="uppercase text-( brand-yellow) fw700 tracking-wide mb6">
          Articles
        </h2>
