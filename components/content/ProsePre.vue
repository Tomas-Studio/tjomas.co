...
<template>
  <div relative>
    <div class="[&>pre]:(px4 pt10 pb2 of-x-auto) focus-visible:( [&>pre]:(outline-1 outline-brand-green outline-dashed)) [&>code]:( [&>pre]:(font-mono text-sm)) border-neutral-3 dark:border-neutral-8 my8 rounded-sm" v-html="highlight" />
